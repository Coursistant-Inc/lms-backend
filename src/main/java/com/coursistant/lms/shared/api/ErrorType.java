...
public enum ErrorType {
    ...
    INVALID_TIMEZONE(HttpStatus.BAD_REQUEST, "Invalid IANA timezone"),
    INVALID_LOCAL_TIME(HttpStatus.BAD_REQUEST, "Local wall-clock time is invalid in the tenant timezone (DST gap or overlap)"),
